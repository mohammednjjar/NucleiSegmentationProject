...
% If you already have a startup script add the following code to this script.
% To be functional, there are specific paths that must be set based on the local machine.
% -------------------------------------------------------------------------
...
%%% e.g. "C:\Users\Program Files\..." OligoArray will not be able to find blast functions.
